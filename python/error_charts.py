...
for row in range(0, 3):
    ...
    for col in range(0, 4):
        ...
        zScoreUpperLimit = [1. + zScoreLimit * calculateSigma(Jw, numIterations, xx) for xx in xForZScoreBand]
        ...
        for algorithmDescription in algorithmDescriptions:
            ...
            for hashSize in hashSizes:
                ...
                if d is not None:
                    empiricalMSE = getEmpiricalMSE( d[histogramDataIdx], hashSize, float(Jw))
                    x.append(hashSize)
